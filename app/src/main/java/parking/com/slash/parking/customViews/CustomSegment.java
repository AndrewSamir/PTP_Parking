 ...
 */
public class CustomSegment extends View {
...
//        CustomSegment.this.setSelectedIndex(mTexts.length - 1);
...
//            Typeface myTypeface = Typeface.createFromAsset(getContext().getAssets(), "fonts/DroidKufi-Regular.ttf");
//            paintText.setTypeface(myTypeface);
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            if (mIsGradient) {
                ...
                CustomSegment.this.setSelectedIndex(position);
            }
        }
    }
