...
public interface ApiCall {
    ...
    @POST(Constant.baseUrl + "User/ChangeUserPassword")
    Call<ModelCommenResponse> callChangeUserPassword(@Body ModelLeaverBookRequest modelLeaverBookRequest, @HeaderMap Map<String, String> headers);
